...
%RsatPath%\InspectCode.exe --caches-home:_ReSharperInspectCodeCache --toolset=14.0 -o:Inspections.xml ..\XmlDocInspections.Plugin.Tests\test\data\XmlDocInspections.Sample.sln || EXIT /B 1
